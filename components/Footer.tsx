...
export default function Footer() {
   return (
      <footer className="flex flex-col items-center max-w-3xl px-6 mx-auto mt-10 lg:max-w-6xl">
            ...
            <ul className="flex items-center justify-center space-x-2 ma-auto">
               ...
               <li>
                  <Link className="footerfill" href="https://github.com/ParkJongho1" target="_blank">
                     <svg className="w-6 h-6 aspect-square" aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true">
                        <path
                           fillRule="evenodd"
               ...
               <li>
                  <Link className="footerfill" href="https://www.instagram.com/jxnghxpark" target="_blank">
